...
See: [Dependency Injection presentation](./dependency-injection-presentation)
...
![Huge dependency graph](/wiki/assets/spring/sample-dependency-graph.png)
...
![Huge dependency graph](/wiki/assets/spring/bean-factory.png)
...
![Bean Factory](/wiki/assets/spring/bean-factory-with-dependencies.png)
...
![ApplicationContext](/wiki/assets/spring/application-context.png)
...
![Bans vs Object instances](/wiki/assets/spring/beans.png)

## Configuration
The container can be configured by **XML files** or **Java classess**.


![Configuration](/wiki/assets/spring/matrix-choose.png)
...
## Placeholders
See: [System properties vs Environment variables](./java-standard-edition/#system-properties-vs-environment-variables)
